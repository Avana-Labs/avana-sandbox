...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-radius-sm text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-3.5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        brand:
          "w-full bg-brand font-normal text-white hover:bg-brand/90 active:bg-brand/80 focus-visible:ring-brand/40 disabled:!opacity-100 disabled:bg-brand-soft disabled:text-brand-soft-foreground",
        // Secondary CTA that pairs with `brand` (matched height/radius).
        "brand-secondary":
          "w-full border border-border bg-surface-raised font-normal text-foreground hover:bg-surface-hover",
        ...
        "table-secondary":
          "w-auto bg-muted font-normal text-foreground group-hover:bg-neutral-300 group-focus-within:bg-neutral-300 dark:group-hover:bg-neutral-700 dark:group-focus-within:bg-neutral-700 disabled:!opacity-100 disabled:!bg-muted disabled:!text-muted-foreground",
        ...
        "table-primary":
          "w-auto bg-brand font-normal text-white hover:bg-brand/90 active:bg-brand/80 focus-visible:ring-brand/40 md:bg-muted md:font-normal md:text-foreground md:hover:!bg-brand/90 md:hover:!text-white md:active:!bg-brand/80 md:active:!text-white md:group-hover:!bg-brand md:group-hover:!text-white md:group-focus-within:!bg-brand md:group-focus-within:!text-white disabled:!opacity-100 disabled:!bg-brand-soft disabled:!text-brand-soft-foreground md:disabled:!bg-muted md:disabled:!text-muted-foreground",
      },
      size: {
        default: "h-9 px-3",
        sm: "h-8 rounded-radius-sm px-2.5 text-xs",
        lg: "h-10 rounded-radius-sm px-4",
        icon: "h-9 w-9",
        // Full-height action-flow CTAs.
        cta: "h-14 rounded-radius-xl px-4 text-base",
        compact: "h-12 rounded-radius-xl px-4 text-base",
        table: "h-auto gap-2 rounded-full px-3.5 py-2 text-sm font-normal [&_svg]:size-4",
      },
    },
    defaultVariants: {
      variant: "default",
