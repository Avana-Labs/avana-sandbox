...
import { ghostButton, mono, paper } from "@/lib/surfaces"
...
export function VoiceConversation({
  ...
  ComponentProps<"div">,
  "children" | "mode" | "amplitude" | "transcript" | "muted" | "onToggleMute" | "onInterrupt" | "onEnd"
> & {
  mode: VoiceMode
  amplitude: number
  ...
  return (
    <div
      ...
      className={cn(paper, "flex w-full max-w-xs flex-col items-center gap-4 rounded-[28px] px-5 py-5", className)}
      ...
      >
        <span
          ...
          className={cn(
            ...
            mode === "speaking" ? "bg-blue-500/12 dark:bg-blue-400/15" : "bg-foreground/[0.05]",
          )}
          style={{
            width: "6rem",
            height: "6rem",
        ...
        <span
          ...
          className={cn(
            ...
            mode === "speaking" ? "bg-blue-500/20 dark:bg-blue-400/25" : "bg-foreground/[0.08]",
          )}
          style={{
            width: "4.25rem",
            height: "4.25rem",
          ...
          >
            <span
              className={cn(
                mono,
                "w-8 shrink-0",
                turn.role === "user" ? "text-foreground/30" : "text-blue-500/70 dark:text-blue-400/70",
              )}
            >
            ...
            <span
              className={cn(
                ...
                turn.role === "user" ? "text-foreground/50" : "text-foreground/80",
              )}
            >
              {turn.text}
            </span>
