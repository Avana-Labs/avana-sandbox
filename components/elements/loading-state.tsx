...
export function GenerationLoader({ label, tick, variant = "dots", className, ...props }: GenerationLoaderProps) {
  ...
  return (
    ...
    >
      ...
      <ShimmerLabel className="text-foreground/55 relative inline-block text-sm">{label}</ShimmerLabel>
    </div>
  )
}
