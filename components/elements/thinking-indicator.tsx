...
// assistant-ui "Thinking indicator" element: a live status line naming what the agent is doing,
// with an optional elapsed time. Pulsing dot + shimmer label so it reads as active.
