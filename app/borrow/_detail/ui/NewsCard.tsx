          ...
          const content = (
            <div className="group flex items-center gap-4 py-3.5">
              <div className="min-w-0 flex-1">
                <div className="text-base font-normal leading-snug text-text-extra-high text-pretty line-clamp-2 underline-offset-2 group-hover:underline group-focus-visible:underline">
                  {t(item.title)}
                </div>
                <div className="mt-1 text-sm text-text-low">
              ...
              <div className="size-14 shrink-0 overflow-hidden rounded-radius-md bg-surface-inset ring-1 ring-border">
                {item.imageUrl ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center text-xs font-normal text-text-low">
