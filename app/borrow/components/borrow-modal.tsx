      ...
      >
          ...
          <div className="space-y-4 px-5 py-4">
              ...
              <div className="mt-2 flex items-center gap-3">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button
                      type="button"
                      className="inline-flex items-center gap-1.5 rounded-xs border border-border bg-surface-inset px-2 h-7 text-[12px] font-medium text-foreground transition-colors hover:bg-surface-hover"
                    >
            ...
            {preview.warningTitle ? (
              <div className="rounded-radius-sm border border-border bg-surface-inset px-3 py-2 text-[11.5px] text-muted-foreground">
            ...
            <dl className="divide-y divide-border rounded-radius-sm border border-border bg-surface-inset overflow-hidden">
              ...
              <StatLine
                ...
                value={<span className="font-data font-medium tabular-nums text-rose-600">{token.borrowApr.toFixed(1)}%</span>}
              />
            </dl>
