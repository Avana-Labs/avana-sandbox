...
export function UmbrellaSidebar({ moduleId: initialModuleId }: { moduleId: UmbrellaMarketId }) {
  ...
  const [moduleId, setModuleId] = useState<UmbrellaMarketId>(initialModuleId)
