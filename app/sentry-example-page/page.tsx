  ...
  return (
    <div>
      <main>
        ...
        <svg height="40" width="40" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Sentry logo">
          <path
        ...
        <p className="description">
          Click a button below, and view the sample error on the Sentry{" "}
          <a target="_blank" rel="noopener" href="https://avana.sentry.io/issues/?project=sentry-byzantine-book">
            Issues Page
          </a>
        ...
        <button
          type="button"
          onClick={() => {
            // Docs alternative: call a function that does not exist.
            // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access
            ;(globalThis as any).myUndefinedFunction()
          }}
          disabled={!isConnected}
        >
          <span>myUndefinedFunction()</span>
        </button>
