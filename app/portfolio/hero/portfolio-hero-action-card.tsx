...
export function PortfolioHeroActionCard({ label, icon: Icon, href, onClick, className }: PortfolioHeroActionCardProps) {
  const classNameValue = `flex min-h-[94px] flex-col items-start justify-between rounded-[16px] border border-[#01AACF]/18 bg-[#dff2fb] px-[22px] py-[14px] text-[#01AACF] shadow-none transition-colors hover:bg-[#d6eef9] dark:border-[#7DDCFF]/14 dark:bg-[#0f1b24] dark:text-[#7DDCFF] dark:hover:bg-[#142331] ${className ?? ""}`
