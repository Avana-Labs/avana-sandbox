...
export function buildDefaultRewardsCatalog(now = Date.now()): RewardTask[] {
  return [
    ...
    },
    {
      ...
      requirement: { type: "event_count", eventTypes: ["sandbox_tour_completed"], targetCount: 1, marketId: "curve-sandbox-tour" },
      expiresAt: now + 30 * DAY_MS,
      repeatable: false,
    },
    {
      ...
      actionLabel: "Start tour",
      actionKind: "sandbox_tour",
      requirement: { type: "event_count", eventTypes: ["sandbox_tour_completed"], targetCount: 1, marketId: "uniswap-v4-sandbox-tour" },
      expiresAt: now + 30 * DAY_MS,
      repeatable: false,
    },
    {
    ...
    },
    {
      ...
      actionLabel: "Grow",
      actionKind: "product_action",
      requirement: { type: "aggregate_volume", eventTypes: ["lend_deposited", "borrow_opened", "multiply_opened"], targetUsd: 1_000 },
      expiresAt: now + 30 * DAY_MS,
      repeatable: false,
    },
    {
