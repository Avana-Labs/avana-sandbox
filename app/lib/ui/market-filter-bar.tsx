...
const INPUT_CLASSES =
  "min-w-0 flex-1 bg-transparent text-[14px] font-normal tracking-[-0.01em] outline-none placeholder:text-muted-foreground dark:text-[#e6f8fb] dark:placeholder:text-muted-foreground/70"
