...
const EXAMPLE_UNI_USDT_ASSET_ID = "uni-v3-bluechip:usdt"
const EXAMPLE_UNI_WETH_ASSET_ID = "uni-v3-bluechip:weth"
const EXAMPLE_CURVE_USDC_ASSET_ID = "curve-crypto:usdc"
