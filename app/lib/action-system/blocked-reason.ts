...
const REASON_RULES: ReasonRule[] = [
  ...
  { match: /\bUNAUTHENTICATED\b/i, message: "Your session has expired. Reconnect your wallet and sign in to continue." },
  { match: /\bWALLET_MISMATCH\b/i, message: "This action doesn't match your connected wallet. Reconnect the right wallet and try again." },
