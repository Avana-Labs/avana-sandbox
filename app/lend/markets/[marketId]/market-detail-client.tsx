...
import { LendSessionModal, type LendSessionModalState } from "@/app/lend/components/lend-session-modal"
    ...
    <main className="container mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="mt-6 flex gap-3">
        <button
          ...
          onClick={() => setModalState({ isOpen: true, marketId, actionType: "deposit" })}
        >
          Deposit
        </button>
        {position ? (
          <button
            ...
            onClick={() => setModalState({ isOpen: true, marketId, actionType: "withdraw" })}
          >
            Withdraw
          </button>
        ) : null}
