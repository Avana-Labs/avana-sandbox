            ...
            {geometry.axisTicks.map((tick) => (
              <g key={`${tick.value}-${tick.y}-label`}>
                <text
                  ...
                  textAnchor="end"
                  className="fill-muted-foreground font-data text-[12.5px] font-normal"
                >
                  {tick.label}
                </text>
              </g>
      ...
      {activePoint ? (
        ...
        >
          <div className="flex flex-col gap-0.5">
            <span className="text-[10px] font-normal text-muted-foreground">{activePoint.label}</span>
            <span className="font-data text-[12.5px] font-normal text-foreground">
