      ...
      <div className="mt-1.5 flex items-center justify-between gap-3 max-[360px]:flex-col max-[360px]:items-start">
        <div className="min-w-0 flex-1">
          <input
            ...
            className={`h-[1em] w-full min-w-0 border-0 bg-transparent p-0 text-[clamp(1.5rem,4vw,2rem)] font-normal leading-none tracking-[-0.04em] outline-none placeholder:text-muted-foreground/60 ${
