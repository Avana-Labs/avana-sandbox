    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={PICKER_CONTENT_CLASS}>
        <DialogHeader className="border-b border-border px-5 pb-3 pt-4 text-left">
          <DialogTitle className="text-sm font-normal">{t("Choose asset to borrow")}</DialogTitle>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto py-1.5">
            ...
            return (
              ...
              >
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                  <span className="truncate text-sm font-normal text-foreground">{token.name}</span>
          ...
          {tokens.length === 0 ? (
            <div className="mx-4 my-3 rounded-radius-sm border border-dashed border-border px-4 py-6 text-center text-xs text-muted-foreground">
