  ...
  return (
    <div className={cn("space-y-3", className)} data-testid="action-health-factor-bar">
      <div className="flex items-center justify-between gap-3">
        ...
        <span
          className={cn(
            "inline-flex items-center gap-1.5 rounded-full bg-surface-inset px-2.5 py-0.5 text-xs font-normal uppercase tracking-wide",
      ...
      <div
        className="font-data text-xl font-normal leading-none tracking-tight text-foreground"
        aria-live="polite"
        aria-atomic="true"
      >
