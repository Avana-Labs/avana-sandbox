...
function PreferencesProfileSyncConnected() {
  ...
  }, [currency, language, setCurrency, setLanguage, setShowDollarAmounts, setTheme, showDollarAmounts, state, theme, wallet])
  ...
  useEffect(() => {
    ...
    const timeoutId = window.setTimeout(() => {
      void savePreferences({ wallet, preferences: nextPreferences })
