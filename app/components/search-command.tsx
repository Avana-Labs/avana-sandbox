      ...
      <button
        ...
        className={
          iconOnly
            ...
            : "flex h-10 w-full items-center gap-2.5 rounded-full border border-[#e6e6e6] bg-[#fafafa] px-3.5 text-left text-[14px] font-normal tracking-[-0.01em] text-[#767676] shadow-none transition-colors hover:bg-[#f3f3f3] lg:h-11 lg:gap-3 lg:px-4 lg:text-[15px] dark:border-border/60 dark:bg-surface-2 dark:text-muted-foreground dark:hover:bg-surface-hover"
        }
      >
        {iconOnly ? (
          ...
          <>
            <Search className="h-[17px] w-[17px] shrink-0 text-[#8a8a8a] dark:text-muted-foreground/80 lg:h-[18px] lg:w-[18px]" />
            <span className="min-w-0 flex-1 truncate">Search pools, borrow, lend, and more</span>
            <span className="flex h-[22px] min-w-[22px] shrink-0 items-center justify-center rounded-[7px] border border-[#dddddd] bg-[#f5f5f5] px-1 text-[10px] font-normal text-[#7a7a7a] lg:h-6 lg:min-w-6 lg:text-[11px] dark:border-border/70 dark:bg-surface-inset dark:text-muted-foreground">
              /
            </span>
          </>
        )}
