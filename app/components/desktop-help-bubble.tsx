  ...
  if (external) {
    return (
      <motion.a
        ...
        onClick={onActivate}
        className="flex items-center justify-between gap-3 rounded-radius-sm px-2.5 py-2.5 text-sm font-normal text-foreground transition-colors hover:bg-hover"
      >
        {content}
      </motion.a>
    )
