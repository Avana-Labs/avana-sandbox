...
- Apply the reviewed development safeguards in [Convex usage guardrails](./convex-usage-guardrails.md); do not reuse development disable thresholds in production.
