...
export const ensureOpenGateBalances = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    return replaceProductBalanceRows(ctx, wallet, {
      ...
      lend: [{ marketId: "usdc", assetId: "usdc", symbol: "USDC", amount: 840, valueUsd: 840, state: "available" }],
      borrow: [
        {
      ...
      multiply: [{ marketId: "aave-gho", assetId: "aave", symbol: "AAVE", amount: 0, valueUsd: 0, state: "available" }],
    })
  },
})
